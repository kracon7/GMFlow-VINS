...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub_vio = n.subscribe("/gvins/odometry", 2000, vio_callback);
    ros::Subscriber sub_image = n.subscribe(IMAGE_TOPIC, 2000, image_callback);
    ros::Subscriber sub_pose = n.subscribe("/gvins/keyframe_pose", 2000, pose_callback);
    ros::Subscriber sub_extrinsic = n.subscribe("/gvins/extrinsic", 2000, extrinsic_callback);
    ros::Subscriber sub_point = n.subscribe("/gvins/keyframe_point", 2000, point_callback);
    ros::Subscriber sub_margin_point = n.subscribe("/gvins/margin_cloud", 2000, margin_point_callback);
